...
export declare const METHOD_SESSION_CONTROL: "session.control";
...
export declare const METHOD_CAN_USE_TOOL: "can_use_tool";
export declare const NOTIF_SIDECAR_READY: "sidecar.ready";
export declare const NOTIF_SESSION_MESSAGE: "session.message";
export declare const NOTIF_SESSION_ERROR: "session.error";
export declare const NOTIF_SESSION_CLOSED: "session.closed";
export declare const NOTIF_LOG: "log";
export declare const METHODS: readonly ["session.create", "session.send", "session.control", "session.resume", "session.close", "ping", "shutdown", "hook.fire", "mcp.call", "can_use_tool"];
export declare const NOTIFICATIONS: readonly ["sidecar.ready", "session.message", "session.error", "session.closed", "log"];
...
export declare const ERROR_CONTROL_FAILED: -32003;
